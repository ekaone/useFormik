        ...
        >
          {({
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <div style={{ paddingTop: 15 }}>
              <Field error={Boolean(errors.projectDuration && touched.projectDuration)} as={Select}  displayEmpty name="projectDuration" type="select" variant="outlined">
                <MenuItem value=""><em>Duration</em></MenuItem>
              ...
              <br />
              <Button variant="contained" color="primary" disabled={isSubmitting} type='submit'>Save</Button>
              <pre>
                {
                JSON.stringify({
                  values: values,
                  test: values.projectDuration.length === 0 ? "empty" : values.projectDuration
                }, null, 2)}
              </pre>
            </Form>
          )}
